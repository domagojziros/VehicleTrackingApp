export const ApplicationName = 'VehicleManagementUnified';

export const ADMINISTRATOR_ROLE: string = "Administrator";
export const BASIC_USER_ROLE: string = "BasicUser";
export const VERIFIED_USER_ROLE: string = "VerifiedUser";

export const USER_ROLES: Array<string> = [ADMINISTRATOR_ROLE, BASIC_USER_ROLE, VERIFIED_USER_ROLE];
